...
export default async function decorate(block) {
  ...
  if (navTools) {
    const toolsExtras = document.createElement('div');
    toolsExtras.className = 'nav-tools-extras';
    toolsExtras.innerHTML = `<button class="nav-lang" aria-label="Select language">EN <span class="nav-lang-arrow">&#x25BE;</span></button>
      <a href="/en/search" class="nav-search" aria-label="Search"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg></a>`;
    navTools.prepend(toolsExtras);
  }
